...
Item.create! code: 'B10001', name: 'Pride and Prejudice', category: Category.first, kind: 'book',
             format: 'paperback', language: 'english', rights: 'public_domain', rating: 10, excerpt: %q(Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean fermentum ligula eu vestibulum cursus.),
...
Copy.create! item: Item.first, name: 'P118127340JA001', quality: 'new', status: 'available'
Copy.create! item: Item.first, name: 'P118127340JA002', quality: 'used', status: 'available'

Membership.create! code: '1001', name: 'Premium Members', kind: 'premium'

Member.create! code: '1234', name: 'John Doe', kind: 'person', membership: Membership.first, address: Address.create!
